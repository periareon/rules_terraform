#!/usr/bin/env bash
# Build the rules_terraform release archive and emit release notes.
...
#
# Side effects:
#   Writes rules_terraform-${TAG}.tar.gz to the current directory. This
...
ARCHIVE="rules_terraform-${TAG}.tar.gz"
